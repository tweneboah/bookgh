            ...
            <div className="flex flex-col items-center gap-10 rounded-[2.5rem] bg-[#e0e3e4] p-8 md:flex-row md:p-10 lg:col-span-8">
              <div className="flex-1">
                ...
                <p className="mb-6 text-[#595c5d]">
                  ...
                  priority runs first. Use negative percentages for discounts and positive for premiums. Keep
                  date ranges explicit so staff see predictable rates at check-in.
                </p>
                <Link
                  href="/bookings"
      ...
      >
        <form onSubmit={handleSubmit} className="relative">
          {(() => {
            ...
            if (urlDepartment) rulesListParams.set("department", urlDepartment);
            if (typeFilter) rulesListParams.set("type", typeFilter);
            const rulesListHref = rulesListParams.toString()
